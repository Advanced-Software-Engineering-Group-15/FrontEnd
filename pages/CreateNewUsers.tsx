      ...
      <ScrollView>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            onChangeText={(text) => { newUserJson.userName = text; }}
          />
        </View>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            placeholderTextColor="#C0C0C0"
            onChangeText={(text) => { newUserJson.firstName = text; }}
          />
        </View>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            placeholderTextColor="#C0C0C0"
            onChangeText={(text) => { newUserJson.familyName = text; }}
          />
        </View>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            placeholderTextColor="#C0C0C0"
            onChangeText={(text) => { newUserJson.phoneNumber = text; }}
          />
        </View>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            placeholderTextColor="#C0C0C0"
            onChangeText={(text) => { newUserJson.emailAddress = text; }}
          />
        </View>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            placeholderTextColor="#C0C0C0"
            onChangeText={(text) => { newUserJson.homeAddress = text; }}
          />
        </View>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            placeholderTextColor="#C0C0C0"
            onChangeText={(text) => { newUserJson.password = text; }}
          />
        </View>
        ...
        <View style={styles.inputView}>
          <TextInput
            ...
            placeholderTextColor="#C0C0C0"
            onChangeText={(text) => { newUserJson.repeated_password = text; }}
          />
        </View>
        {warning
